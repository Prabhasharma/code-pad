...
describe("Javascript Component",()=>{
    ...
    test('Should Download the Code:',()=>{
      ...
      expect(downloadLink).toHaveAttribute('href', expect.stringContaining('CodePad-'));
      expect(downloadLink).toHaveAttribute('download', expect.stringContaining('CodePad-'));
    })
})
...
describe("Python Component",()=>{
    ...
    test('Should Update Code onChange',()=>{
      ...
      const codeTextarea = screen.getByPlaceholderText('print("hello codePlayers")');
...
//         // const textEle = screen.getByText("PrAbha")

//         //regrex text matching query
//         // const textEle = screen.getByText(/prabha/i)     //substring match,ignore case
//         // const textEle = screen.getByText(/^prabha$/i)       //substring match,ignore case
